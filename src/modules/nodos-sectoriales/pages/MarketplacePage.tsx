  ...
  const MarketplaceDiagram = () => (
    <div className="flex flex-col md:flex-row items-center justify-center gap-8 py-8">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="text-xs text-slate-500 mt-2">{t('pages.marketplace.diagram.sources.0')}</div>
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-white px-3 py-1 rounded-full shadow-md border border-orange-200">
            <span className="text-xs font-semibold text-orange-600">{t('pages.marketplace.diagram.filters.2')}</span>
          </div>
        </div>
        <div className="text-xs text-slate-500 mt-6">{t('pages.marketplace.diagram.filters.0')} & {t('pages.marketplace.diagram.filters.1')}</div>
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex items-center gap-1 mt-2">
          ...
          <span className="text-xs text-emerald-600 font-medium">{t('pages.marketplace.diagram.outputs.0')}</span>
        </div>
      </div>
    </div>
  );
