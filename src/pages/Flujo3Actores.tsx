...
import { Flujo3ActoresInfographic } from "@/components/flujo-3-actores/Flujo3ActoresInfographic";
import { Flujo3ActoresChatAgent } from "@/components/flujo-3-actores/Flujo3ActoresChatAgent";
...
const metrics = [
  { key: "actors", value: 3, suffix: "" },
  { key: "states", value: 5, suffix: "" },
      ...
      <section className="py-16 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="container mx-auto px-4">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 text-primary text-xs font-medium mb-5">
            <GitBranch className="w-3.5 h-3.5" /> {t("badge")}
          </div>
