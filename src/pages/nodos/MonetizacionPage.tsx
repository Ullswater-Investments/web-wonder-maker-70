  ...
  return (
    <div className="flex flex-col items-center py-8">
      ...
      <div className="flex items-center gap-3 bg-white px-6 py-4 rounded-2xl border border-slate-200 shadow-sm mb-6">
        ...
        <div>
          <div className="font-semibold text-slate-800">{t('pages.monetization.diagram.dataTransaction')}</div>
          <div className="text-sm text-slate-500">{t('pages.monetization.diagram.completed')}</div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-amber-400 to-amber-500 rounded-2xl px-8 py-4 shadow-lg shadow-amber-500/20 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-xs text-amber-100 font-medium">{t('pages.monetization.diagram.transactionValue')}</div>
        ...
        <div className="flex flex-col items-center">
          <div className="bg-emerald-100 rounded-2xl p-6 border border-emerald-200 min-w-[200px]">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="font-semibold text-emerald-800">{t('pages.monetization.diagram.provider')}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-emerald-700">5.600€</div>
              <div className="text-xs text-emerald-600 mt-1">{t('pages.monetization.diagram.automaticTransfer')}</div>
            </div>
          </div>
          <div className="mt-2 text-xs text-slate-500">{t('pages.monetization.diagram.dataOwner')}</div>
        </div>
        ...
        <div className="flex flex-col items-center">
          <div className="bg-orange-100 rounded-2xl p-6 border border-orange-200 min-w-[200px]">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="font-semibold text-orange-800">{t('pages.monetization.diagram.nodePromoter')}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-700">1.400€</div>
              <div className="text-xs text-orange-600 mt-1">{t('pages.monetization.diagram.automaticCommission')}</div>
            </div>
          </div>
          <div className="mt-2 text-xs text-slate-500">{t('pages.monetization.diagram.yourCluster')}</div>
        </div>
      </div>
      ...
      <div className="mt-8 flex items-center gap-2 bg-slate-800 px-4 py-2 rounded-full">
        ...
        <span className="text-sm text-slate-200">{t('pages.monetization.diagram.instantSettlement')} <span className="font-semibold text-white">EUROe Stablecoin</span></span>
      </div>
    </div>
  );
};
