...
export const caseFlowConfigs: Record<string, CaseFlowConfig> = {
  ...
  "sky-aero-systems": {
    nodes: [
      ...
      { id: "supplier", label: "Proveedor Tier 1", x: 420, y: 80, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "vinosdoe-elite": {
    nodes: [
      ...
      { id: "blockchain", label: "Pontus-X", x: 420, y: 80, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "pharmacold-logistix": {
    nodes: [
      ...
      { id: "smart", label: "Smart Contract", x: 420, y: 320, color: "hsl(142, 71%, 45%)", size: 26 },
      { id: "euroe", label: "Escrow EUROe", x: 80, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "portbcn-smart-trade": {
    nodes: [
      ...
      { id: "kyb", label: "Validación KYB", x: 80, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "ayuntamiento-etico": {
    nodes: [
      ...
      { id: "sroi", label: "Dashboard SROI", x: 420, y: 80, color: "hsl(142, 71%, 45%)", size: 26 },
      { id: "lgd", label: "Verificador LGD", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 24 },
  ...
  "purelithium-sourcing": {
    nodes: [
      ...
      { id: "auto", label: "Automotriz", x: 250, y: 380, color: "hsl(32, 94%, 54%)", size: 24 },
    ],
    connections: [
  ...
  "fastfashion-trace": {
    nodes: [
      ...
      { id: "cert", label: "Certificación", x: 80, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "invoicetrust-b2b": {
    nodes: [
      ...
      { id: "score", label: "Trade Finance Score", x: 420, y: 80, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "gridflow-energy": {
    nodes: [
      ...
      { id: "liquid", label: "Liquidación Auto", x: 80, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "ailabs-research": {
    nodes: [
      ...
      { id: "gdpr", label: "Anonimizador GDPR", x: 420, y: 80, color: "hsl(142, 71%, 45%)", size: 24 },
      { id: "synth", label: "Generador Sintético", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "helios-fields": {
    nodes: [
      ...
      { id: "edge", label: "Edge Functions", x: 420, y: 80, color: "hsl(187, 100%, 42%)", size: 24 },
      { id: "erp", label: "Conector ERP", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "aeolus-wind": {
    nodes: [
      ...
      { id: "euroe", label: "Wallet EUROe", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 24 },
  ...
  "h2-pure": {
    nodes: [
      ...
      { id: "pontus", label: "Pontus-X Notary", x: 420, y: 80, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "gridflex-demand": {
    nodes: [
      ...
      { id: "euroe", label: "Wallet EUROe", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "bioheat-district": {
    nodes: [
      ...
      { id: "passport", label: "Pasaporte Digital", x: 420, y: 80, color: "hsl(142, 71%, 45%)", size: 26 },
      { id: "did", label: "Validador DID", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 24 },
  ...
  "turbine-chain": {
    nodes: [
      ...
      { id: "report", label: "Reporte Consolidado", x: 250, y: 380, color: "hsl(32, 94%, 54%)", size: 24 },
    ],
    connections: [
  ...
  "aquapower-nexus": {
    nodes: [
      ...
      { id: "dash", label: "Dashboard Nexo", x: 250, y: 380, color: "hsl(32, 94%, 54%)", size: 24 },
    ],
    connections: [
  ...
  "smartcharge-ev": {
    nodes: [
      ...
      { id: "notary", label: "API Nodo Notario", x: 420, y: 80, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "fiber-loop": {
    nodes: [
      ...
      { id: "pontus", label: "Pontus-X Notary", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "rare-earth-recover": {
    nodes: [
      ...
      { id: "edge", label: "Edge Functions", x: 420, y: 80, color: "hsl(187, 100%, 42%)", size: 24 },
      { id: "ia", label: "IA Analytics", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "alu-cycle": {
    nodes: [
      ...
      { id: "carbon", label: "Carbon Tracker", x: 80, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "producer-trust": {
    nodes: [
      ...
      { id: "ssi", label: "Identidad SSI", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 24 },
  ...
  "raw-market": {
    nodes: [
      ...
      { id: "cert", label: "Certificación Pureza", x: 80, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "battery-life": {
    nodes: [
      ...
      { id: "audit", label: "Audit Logs", x: 420, y: 80, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "waste-to-value": {
    nodes: [
      ...
      { id: "erp", label: "Conectores ERP", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "green-gov-circular": {
    nodes: [
      ...
      { id: "did", label: "Validador DID", x: 420, y: 80, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "avocado-trust": {
    nodes: [
      ...
      { id: "pontus", label: "Pontus-X Notary", x: 80, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "zero-chem-wine": {
    nodes: [
      ...
      { id: "lab", label: "API Laboratorio", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "citrus-check": {
    nodes: [
      ...
      { id: "cert", label: "Certificación Multi-País", x: 80, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "berry-water": {
    nodes: [
      ...
      { id: "caudal", label: "Caudalímetro Digital", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "rice-satellite": {
    nodes: [
      ...
      { id: "blockchain", label: "Blockchain Hash", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 24 },
  ...
  "bio-cotton-trace": {
    nodes: [
      ...
      { id: "passport", label: "Pasaporte Producto", x: 420, y: 80, color: "hsl(142, 71%, 45%)", size: 26 },
      { id: "gots", label: "Certificación GOTS", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "greenhouse-ai": {
    nodes: [
      ...
      { id: "score", label: "Score Fitosanitario", x: 250, y: 380, color: "hsl(32, 94%, 54%)", size: 24 },
    ],
    connections: [
  ...
  "tropical-flash": {
    nodes: [
      ...
      { id: "webhook", label: "Webhooks IDS", x: 80, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
  ...
  "urban-hydro": {
    nodes: [
      ...
      { id: "passport", label: "Pasaporte Local", x: 250, y: 380, color: "hsl(32, 94%, 54%)", size: 24 },
    ],
    connections: [
  ...
  "greenfinance-esg": {
    nodes: [
      ...
      { id: "bond", label: "Green Bond", x: 420, y: 320, color: "hsl(32, 94%, 54%)", size: 26 },
