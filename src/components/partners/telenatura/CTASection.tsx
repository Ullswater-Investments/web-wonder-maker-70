      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            ¿Listo para digitalizar tu explotación?
          </h2>
          <p className="text-lg text-green-100 mb-8">
            Contacta con TeleNatura para una consulta personalizada sobre automatización, 
            telemetría y agricultura de precisión.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-3xl mx-auto">
            ...
            <Card className="bg-white/10 border-white/20">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-sm text-green-200">Teléfono</p>
            ...
            <Card className="bg-white/10 border-white/20">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-sm text-green-200">Ubicación</p>
