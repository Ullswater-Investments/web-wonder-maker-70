...
export default function AcceptanceActContent({
  ...
  const points = [
    ...
    },
    {
      ...
      content: "AUTORIZO IRREVOCABLEMENTE la activación de la financiación a través de HOKODO por importe de 1.500€ + IVA, pagaderos en 6 cuotas mensuales de 250€ + IVA.",
